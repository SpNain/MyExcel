...
function initDB() {
    ...
    db = newDB; // jb bhi sheet switch/create hogi to usme humne initDB wala fxn chla rkha hoga to is line se sheet creation or switching ke time hmara db var me uska corresponding newDB set ho jaayega 
...
/*
#1. Problem : jab bhi hum visitedCells var me {rowId,colId} obj push krte hai to usse dbObject.visitedCells me kaise change aa rha hai
Ans : Humne dbObject me visitedCells naam se key bnai jisme ek empty aaray hai lets say iska address hai 2k.
